...
public class MonthlyReport {
    ...
    public MonthlyReport(int month) {
        ...
        if (content != null) {
            ...
            System.out.println("Ошибка считывания отчета");
    }
    ...
    public void dataMonth() {
        ...
        for (MonthRecord monthRecord : monthList) {
            ...
            if (!monthRecord.isExpense()) {
                report.put((monthRecord.getQuantity() * monthRecord.getSumOfOne()), monthRecord.getItemName());
        ...
        for (MonthRecord monthRecord : monthList) {
            ...
            if (monthRecord.isExpense()) {
                expense.put((monthRecord.getQuantity() * monthRecord.getSumOfOne()), monthRecord.getItemName());
